            ...
            <CardBody>
                ...
                <div className="text-center">
                    <div className="avatar-sm mx-auto mb-4">
                        <span className="avatar-title rounded-circle bg-warning-subtle font-size-24">
                            <i className="mdi mdi-facebook text-warning"></i>
                        </span>
                    </div>
                    ...
                    <Col className="col-4">
                        <div className="social-source text-center mt-3">
                            <div className="avatar-xs mx-auto mb-3">
                                <span className="avatar-title rounded-circle bg-warning font-size-16">
                ...
                <div className="mt-3 text-center">
                    <Link to="#" className="text-warning font-size-14 fw-medium">View All Sources <i className="mdi mdi-chevron-right"></i></Link>
                </div>
